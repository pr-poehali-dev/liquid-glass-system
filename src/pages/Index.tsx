        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
          ...
          <Card className="bg-white/40 backdrop-blur-xl border-white/60 shadow-xl rounded-2xl p-5 col-span-2">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h2 className="font-bold text-gray-800 text-2xl">Ожидание подписания</h2>
            </div>
            <div className="space-y-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <Card className="bg-white/40 backdrop-blur-xl border-white/60 shadow-xl rounded-2xl p-5">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h2 className="font-bold text-gray-800 text-2xl">Связь мер поддержки с ОКВЭД</h2>
            </div>
          ...
          <Card className="bg-white/40 backdrop-blur-xl border-white/60 shadow-xl rounded-2xl p-5">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h2 className="font-bold text-gray-800 text-2xl">Поручения главы</h2>
            </div>
            <div className="space-y-2">
              {tasks.map((task, idx) => (
                <div 
